...
for batch in ('test', 'train'):
   fpath = os.path.join('/home/yiran/xxm/datasets/cifar100/cifar-100-python', batch)

   f = open(fpath, 'rb')
   labels = pickle.load(open(os.path.join('/home/yiran/xxm/datasets/cifar100/cifar-100-python', 'meta'), 'rb'), encoding="ASCII")
